...
function DashboardComponent(props) {
        const [state, setState] = useState({
            tabItem: ['HOME', 'SKILLS', 'PROJECTS', 'RESUME'],
            selectedItem: 'HOME'
        })
            ...
            return (
                <div className="resume-container">
                    <div className="resume-temp">
                        <div className="blogs-mobile-container">
                            <BlogsComponent />
                        </div>
                        <div className={'contacts-mobile-container'}>
                ...
                <div className={'mobile-parent-container'}>
                    ...
                    <div className={'mobile-footer-container'}>
                        {state.tabItem.map(data =>
                            <div key={data} className={state.selectedItem === data ? 'bottom-menu-item-selected-container' : 'bottom-menu-item-container'} onClick={() => setSelectedTab(data)}>
                                <span className={state.selectedItem === data ? 'bottom-menu-selected-item-txt' : 'bottom-menu-item-txt'}>{data}</span>
                            </div>
                        )}
                    </div>
                </div>
                <div className={'desktop-parent-container'}>
                    <div className={'menu-bar-container'}>
                        ...
                        <div className={'menu-item-container'}>
                            ...
                            <a href="#blogs" className={'menu-item-txt'}><span>RESUME</span></a>
                    ...
                    <div id={'blogs'} className={'blogs-parent-container'}>
                        <div className={'skills-container'}>
                            <span className={'dashboard-skills-label'}>Resume</span>
                        </div>
                        <BlogsComponent />
                    </div>
